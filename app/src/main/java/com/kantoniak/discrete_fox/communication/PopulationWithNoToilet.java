...
import com.kantoniak.discrete_fox.communication.ContentObject;
...
/**
 * Class that parses the specific data for population without toilets.
 */
public class PopulationWithNoToilet extends ContentObject {
    PopulationWithNoToilet() {
    }
        ...
        try {
            ...
            while (tempCountry.hasNext()) {
                ...
                while (tempYear.hasNext()) {
                    ...
                    int key = (idx1 * size.getInt(6) + idx2);
